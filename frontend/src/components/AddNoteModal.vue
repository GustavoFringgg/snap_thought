        ...
        >
          ...
          <div class="modal__body">
            ...
            <div class="modal__tags">
              <span class="modal__tags-label">標籤</span>
              <button
                v-for="t in NOTE_TAGS"
                :key="t"
                class="modal__tag-chip"
                :class="{ 'modal__tag-chip--active': selectedTag === t }"
                :style="selectedTag === t ? `background:${TAG_COLORS[t].bg};color:${TAG_COLORS[t].text};border-color:${TAG_COLORS[t].border}` : ''"
...
const emit = defineEmits<{
  close: [];
  submit: [content: string, tag: NoteTag | null];
}>();
...
function submit() {
  ...
  if (!content) return;
  emit("submit", content, selectedTag.value);
  emit("close");
}
</script>
